<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Vanaraha.Web.Default" %>
                        ...
                        <div class="Options_Block Options_Block_Blue">
                            <div class="Options_Head clearfix ">
                                ...
                                <span class="pull-right">
                                    <span class="glyphicon glyphicon-refresh Status_Text" ng-click="updateItems(1)" aria-hidden="true" title="Refresh"></span>
                                </span>
                            </div>
                            <div class="Options_Body">
                                <ul class="Option_list color_bullet">
                                    <li class="clearfix" ng-repeat="itemLink1 in grid1ItemLinks">
                                        <div><a href="{{itemLink1.LinkUrl}}" target="_blank" class="list_bullet">{{$index + 1}}</a></div>
                                        <span class="listdrop"><a href="{{itemLink1.LinkUrl}}" target="_blank" title="{{itemLink1.ItemLinkName}}">{{itemLink1.ItemLinkName}}</a></span>
                                        <div class="float_Button tcell">
                                            <span class="glyphicon glyphicon-time" aria-hidden="true"></span>
                                            <span>{{itemLink1.TimeSince}}
                                            </span>
                                        </div>
                                    </li>
                                </ul>
